// packages/ui/src/examples/Resizable.example.tsx
      ...
      <ResizablePanelGroup direction='horizontal'>
        <ResizablePanel defaultSize={25} minSize={15} maxSize={40}>
          <div className='p-4 bg-surface h-full'>
            ...
            <p className='text-sm text-muted-foreground'>This panel can be resized</p>
          </div>
        </ResizablePanel>
  ...
  return (
    <div className='h-screen'>
      <ResizablePanelGroup
        ...
        onLayout={(sizes) => console.warn('Layout changed:', sizes)}
      >
        <ResizablePanel id='sidebar' defaultSize={25} minSize={15}>
          <div className='p-4 bg-surface h-full'>
            <h2 className='text-lg font-semibold mb-2'>Sidebar</h2>
            <p className='text-xs text-muted-foreground'>Layout is auto-saved!</p>
          </div>
        </ResizablePanel>
    ...
    <div className='h-screen'>
      <ResizablePanelGroup direction='horizontal'>
        <ResizablePanel
          ...
          collapsible
          collapsedSize={0}
          onCollapse={() => console.warn('Panel collapsed')}
          onExpand={() => console.warn('Panel expanded')}
        >
          <div className='p-4 bg-surface h-full'>
            <h2 className='text-lg font-semibold mb-2'>Collapsible Sidebar</h2>
            <p className='text-xs text-muted-foreground'>Drag to edge to collapse</p>
          </div>
        </ResizablePanel>
    ...
    <div className='h-screen'>
      ...
      >
        ...
        <ResizablePanel
          ...
          collapsible
        >
          <div className='p-4 bg-surface h-full overflow-auto'>
